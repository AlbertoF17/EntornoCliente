...
// console.log(`La longitud de '${helloWorld}' es: `, longitud); //CON TEMPLATE STRING
...
// //se puede iterar de otra forma
// for (let [numPropiedad, propiedad] of Object.entries(objeto)) {
//     console.log(numPropiedad + " - " + propiedad);
// }
// */
...
//         frame = 0;
//     }
//     console.log("Estás en el segundo: ", segundo, " en su frame: ", frame);

// }

// setInterval(mostrarFps, 1000/30);
// */